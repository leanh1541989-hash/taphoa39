...
export class GroupService {
  ...
  group(products: any[],): Record<number, any[]> {
    ...
    products.forEach((product: any) => {
      // Check if this is a child product (has MasterUnitId)
      // Case 1: MasterProductId !== null && MasterUnitId !== null (unit variant with attributes)
      // Case 2: MasterProductId === null && MasterUnitId !== null (unit variant without attributes)
      if (product.MasterUnitId !== null) {
        // Convert MasterUnitId to number
