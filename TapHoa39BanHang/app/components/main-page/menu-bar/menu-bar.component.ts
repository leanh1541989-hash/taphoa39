...
export class MenuBarComponent {
  ...
  showEmployeeSubmenuFlag: boolean = false;
  showAccountingSubmenuFlag: boolean = false;
  ...
  showEmployeeSubmenu() {
    this.showEmployeeSubmenuFlag = true;
  }

  hideEmployeeSubmenu() {
    this.showEmployeeSubmenuFlag = false;
  }

  showAccountingSubmenu() {
    this.showAccountingSubmenuFlag = true;
  }

  hideAccountingSubmenu() {
    this.showAccountingSubmenuFlag = false;
  }
}