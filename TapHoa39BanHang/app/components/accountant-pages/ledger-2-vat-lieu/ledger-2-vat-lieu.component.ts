...
export class Ledger2VatLieuComponent implements OnInit {
  ...
  dataColumns: DataColumn[] = [
    ...
    { key: 'nhapSoLuong', type: 'number' },
    { key: 'nhapThanhTien', type: 'number' },
    { key: 'xuatSoLuong', type: 'number' },
    { key: 'xuatThanhTien', type: 'number' },
    { key: 'tonSoLuong', type: 'number' },
    { key: 'tonThanhTien', type: 'number' },
